...
namespace ST
{
    public class PictureManager : MonoBehaviour
    {
        ...
        private Vector2 _offsetF0r12Pairs = new Vector2(1.05f, 1.2f);
        ...
        void Start()
        {
            ...
            else if(GameSettings.Instance.GetPairNumber() == GameSettings.EPairNumber.E12Pairs)
            {
                CurrentGameState = GameState.MovingOnPositions;
                SpawnPictureMesh(6, 4, StartPosition, _offset, true);
                MovePicture(6, 4, StartPosition, _offsetF0r12Pairs);
            }
        }
